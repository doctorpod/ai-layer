...
Each wayfinder project lives at `_wayfinder/<kebab-case-slug>/map.md`.
...
1. **Scan first** — check `_wayfinder/` for a close match. If one exists, offer to add to it instead of starting a new project.
